...
#define CORRECT_THRESHOLD 0.05
///#define CORRECT_THRESHOLD_SECOND 0.55
//#define CORRECT_THRESHOLD_HOMOPOLYMER 0.515
#define CORRECT_THRESHOLD_HOMOPOLYMER 0.315
#define MIN_COVERAGE_THRESHOLD 3//设置的最低覆盖度的阈值
...
void correct_overlap(overlap_region_alloc* overlap_list, All_reads* R_INF, 
                        UC_Read* g_read, Correct_dumy* dumy, UC_Read* overlap_read, Graph_asm* g, Graph_asm* DAGCon, 

...
int add_and_check_bi_direction_edge(Graph_asm *graph, Node_asm *in_node, Node_asm *out_node, uint64_t weight, uint64_t flag);
void add_bi_direction_edge(Graph_asm *graph, Node_asm *in_node, Node_asm *out_node, uint64_t weight, uint64_t flag);
int remove_and_check_bi_direction_edge_from_nodes(Graph_asm *graph, Node_asm *in_node, Node_asm *out_node);
int remove_and_check_bi_direction_edge_from_edge(Graph_asm *graph, Edge_asm *e);

inline int Pop_Node(Graph_asm *DAGCon, Node_asm **node)
{
    long long nodeID = 0;
...
inline int Push_Node(Graph_asm *DAGCon, Node_asm **node)
{
...
inline int getInputNodes(RSet *set, Graph_asm *graph, Node_asm *node, Node_asm **get_Node)
{
...
inline int getInputEdges(RSet *set, Graph_asm *graph, Node_asm *node, Edge_asm **get_Edge)
{
    if (set->index >= (long long)Input_Edges(*node).length)
    {
        return 0;
...
inline int getOutputNodes(RSet *set, Graph_asm *graph, Node_asm *node, Node_asm **get_Node)
{
...
inline int getOutputEdges(RSet *set, Graph_asm *graph, Node_asm *node, Edge_asm **get_Edge)
{
    if (set->index >= (long long)Output_Edges(*node).length)
    {
        return 0;
...
inline void get_bi_direction_edges(Graph_asm *DAGCon, Edge_asm *edge, Edge_asm **e_forward, Edge_asm **e_backward)
{
...
inline long long get_bi_Edge(Graph_asm *DAGCon, Node_asm *inNode, Node_asm *outNode, Edge_asm **e_forward, Edge_asm **e_backward)
{
    Edge_asm *e;
    RSet iter;
    clear_RSet(&iter);
...
inline long long get_Edge_Weight(Graph_asm *DAGCon, Node_asm *inNode, Node_asm *outNode)
{
...
void init_Graph(Graph_asm *g);
void addUnmatchedSeqToGraph(Graph_asm *g, char *g_read_seq, long long g_read_length, long long *startID, long long *endID);
void addmatchedSeqToGraph(Graph_asm *backbone, long long currentNodeID, char *x_string, long long x_length,
...
void destory_Graph(Graph_asm *g);
void clear_Graph(Graph_asm *g);
void Perform_POA(Graph_asm *g, overlap_region_alloc *overlap_list, All_reads *R_INF, UC_Read *g_read);

uint64_t inline add_Node_Graph(Graph_asm *g, char base)
{
    return append_Node_alloc(&g->g_nodes, base);
}

inline Node_asm *add_Node_DAGCon(Graph_asm *g, char base)
{
...
uint64_t inline delete_Node_DAGCon(Graph_asm *g, Node_asm *node)
{
...
inline void add_mismatchEdge_weight(Graph_asm *g, uint64_t in_node, char base, int last_operation)
{
    long long i = 0;
    long long nodeID;
...
inline void add_single_deletionEdge_weight(Graph_asm *g, long long alignNodeID, long long nextNodeID, uint64_t edge_length)
{
    long long i = 0;
    long long nodeID;
...
inline void add_deletionEdge_weight(Graph_asm *g, long long alignNodeID, long long deletion_length)
{
    long long i;
...
inline int getEdge(Graph_asm *g, Edge_alloc *edge, uint64_t edge_length, char base)
{
    long long i = 0;
    long long nodeID;
...
inline int get_insertion_Edges(Graph_asm *g, Edge_alloc *edge, uint64_t edge_length, char *bases)
{
    long long i = 0;
    long long nodeID;
    long long edgeID;
...
inline int create_insertion_Edges(Graph_asm *g, long long alignNodeID, uint64_t edge_length, char *bases)
{
    long long i = 0;
    long long nodeID;
...
inline void extract_path(Graph_asm *backbone, int debug_node_in_backbone, int path_i, char *pre)
{
...
inline int get_insertion_Edges_new(Graph_asm *backbone, int debug_node_in_backbone, uint64_t edge_length, char *bases)
{
...
inline void add_insertionEdge_weight(Graph_asm *g, long long alignNodeID, char *insert, long long insert_length)
{
